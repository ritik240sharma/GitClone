...
function ProfileInfo () {
	const {loading, userProfile}=getUser();
	if(loading)return<Spinner/>
	return (
		<div className='lg:w-1/3 w-full flex flex-col gap-2 lg:sticky md:top-10 z-0'>
			<div className='bg-glass shadow-lg border border-gray-200 hover:bg-red-50 rounded-lg p-4'>
